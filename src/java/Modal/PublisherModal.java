...
//            dbH.closeConnection();
    ...
    public String existsPublisher(String data) throws SQLException{
        try {
            LibraryHelper dbHL = new LibraryHelper("publishers");
            ResultSet results = dbHL.checkExists("publishers",data);
            while (results.next()) {
