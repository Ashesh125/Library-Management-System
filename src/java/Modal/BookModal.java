...
//            dbH.closeConnection();
    ...
    public boolean updateBook(Book book) throws SQLException {
        try {
            ...
            values[6] = temp.toString();
            temp = book.getQuantity();
            values[7] = temp.toString();
            ...
            values[9] = book.getImage();
            values[10] = book.getPdf();
...
//            dbH = new DatabaseHelper("books");
    ...
    public ArrayList<Book> fetchBorrowedBooks(String id) throws SQLException {
        ArrayList<Book> books = new ArrayList<>();
        try {
            LibraryHelper dbHL = new LibraryHelper("books");
//            dbH = new DatabaseHelper("books");
            ResultSet results = dbHL.fetchBorrowedBooks(id);
            while (results.next()) {
                Book a = new Book();
                a.setId(results.getString("books_Id"));
                a.setName(results.getString("book_Name"));
                ...
                a.setImage(results.getString("book_Image"));
                a.setPdf(results.getString("book_PDF"));
                a.setIssue_date(results.getString("borrowed_Date"));
                a.setDue_date(results.getString("due_Date"));
                books.add(a);
            }
            return books;
