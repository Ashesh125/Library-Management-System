...
public class PatronService extends Patron {
    ...
    public boolean check(String[] data) throws SQLException, EmptyValueException {
        ...
        String hash = data[5].equals("")?"" :Utilities.Hash.getHash(data[2]);
    ...
    public boolean changePassword(String[] datas) throws SQLException{
        String h = Utilities.Hash.getHash(datas[1] + datas[2]);
        System.out.println(datas[1]+"   "+datas[2]);
        if (patronModal.updatePassword(datas[0],h)) {
                return true;
        }else{
            return false;
        }
